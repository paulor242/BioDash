  ...
  return (
    <ResponsiveContainer width="100%" height={340}>
      ...
      >
        ...
        <Line
          type="monotone"
          dataKey="aceleration_max_avg"
          name="aceleracion maxima promedio"
        ...
        <Line
          type="monotone"
          dataKey="aceleration_max"
          name="aceleracion maxima"
